...
/*!
 * @brief Select Digital mode.: Disable digital mode. Digital input set to 0. */
#define PIO1_9_DIGIMODE_ANALOG 0x00u
/*!
 * @brief Selects pin function.: Alternative connection 0. */
...
/*! @name PIO1_9 (number 10), S3/P18[1]/PIO1_9_GPIO_ARD
  @{ */
#define BOARD_INITADC_S3_GPIO GPIO                /*!<@brief GPIO device name: GPIO */
#define BOARD_INITADC_S3_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_INITADC_S3_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_INITADC_S3_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
#define PIO1_26_FUNC_ALT2 0x02u
/*!
 * @brief Select Digital mode.: Enable Digital mode. Digital input is enabled. */
