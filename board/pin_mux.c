...
- pin_list:
  ...
  - {pin_num: '10', peripheral: ADC0, signal: 'CH, 12', pin_signal: PIO1_9/FC1_SCK/CT_INP4/SCT0_OUT2/FC4_CTS_SDA_SSEL0/ADC0_12}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitADC(void)
{
    ...
    GPIO_PinInit(GPIO, 1U, 9U, &S3_config);
    ...
    if (Chip_GetVersion()==1)
    {
        IOCON->PIO[1][9] = ((IOCON->PIO[1][9] &
                        ...
                        /* Selects pin function.
                         * : PORT19 (pin 10) is configured as ADC0_12. */
...
- options: {callFromInitBoot: 'true', coreID: cm33_core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '1', peripheral: SCT0, signal: 'OUT, 0', pin_signal: PIO1_4/FC0_SCK/SD0_D0/CTIMER2_MAT1/SCT0_OUT0/FREQME_GPIO_CLK_A}
  - {pin_num: '43', peripheral: SCT0, signal: 'OUT, 4', pin_signal: PIO1_17/FC6_RTS_SCL_SSEL1/SCT0_OUT4/SD1_CARD_INT_N/SD1_CARD_DET_N}
  - {pin_num: '68', peripheral: SCT0, signal: 'OUT, 3', pin_signal: PIO1_26/FC2_CTS_SDA_SSEL0/SCT0_OUT3/CT_INP3/UTICK_CAP1/HS_SPI_SSEL3/PLU_IN5}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitSCT
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
/* Function assigned for the Cortex-M33 (Core #0) */
void BOARD_InitSCT(void)
{
    /* Enables the clock for the I/O controller.: Enable Clock. */
    CLOCK_EnableClock(kCLOCK_Iocon);
    ...
    IOCON->PIO[1][26] = ((IOCON->PIO[1][26] &
                         ...
                         /* Selects pin function.
                          * : PORT126 (pin 68) is configured as SCT0_OUT3. */
                         | IOCON_PIO_FUNC(PIO1_26_FUNC_ALT2)
